...
#
# Author: Dave Ahijevych
# Contact: ahijevyc@ucar.edu
#
#--------BEGIN USER INPUT-----------#

# Additional fort.15 configure settings
 set runid = "irma control"
 set ihot = 367
 ...
 # output filename. Full paths.
  set f15_tmpl = "/glade/work/ahijevyc/ADCIRC/IRMA/fort.15.nos.control.template"
