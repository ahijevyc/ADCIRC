...
A=NMMM0021
stormname=IRMA
for desc in vmax_from_besttrack besttrack_vmax_at_25.2N besttrack_minp_vmax_at_25.2N ; do
    for minus_tide in False ; do 
        ...
        #for f in nws20.2017090812.EPS_14.27km3km WRF.2017090812.EPS_14.27km3km; do
            for f in ECMWF.0p125.nws19.$desc.2017090812.?*; do
                ...
                echo ncl \'dryland=\"$dryland\"\' \'stormname=\"$stormname\"\' minus_astronomical_tide=$minus_tide \'modelstr=\"$f\"\' \'region=\"FloridaSW\"\' ymax=3.5 /glade/work/ahijevyc/ADCIRC/inundation_timeseries.ncl | tee -a cmd.$f.exe
